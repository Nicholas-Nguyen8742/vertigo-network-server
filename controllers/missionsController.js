...
exports.index = (_req, res) => {
    knex('missions')
      ...
      .select('users.firstName', 'users.lastName', 'users.profile', 'users.email', 'missions.latitude', 'missions.longitude', 'missions.specialty', 'missions.city', 'missions.state', 'missions.date', 'missions.timestamp', 'missions.id')
      .then((data) => {
